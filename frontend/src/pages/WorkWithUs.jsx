...
export default function WorkWithUs() {
  return (
    <>
      <Helmet>
        <title>
          Work With Growth Wave Digital
        </title>

        <meta
          name="description"
          content="Start your project with Growth Wave Digital. Request a proposal and receive a free business audit."
        />

        <link
          rel="canonical"
          href="https://www.growthwave.site/work-with-us"
        />
      </Helmet>
