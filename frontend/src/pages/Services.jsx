...
export default function Services() {
  return (
    <>
      <Helmet>
        <title>
          Digital Marketing Services | Growth Wave Digital
        </title>

        <meta
          name="description"
          content="Professional SEO, Local SEO, Shopify, WordPress, AI Automation, Social Media Marketing and Lead Generation services."
        />

        <link
          rel="canonical"
          href="https://www.growthwave.site/services"
        />
      </Helmet>
