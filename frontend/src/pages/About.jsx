...
const team = [
  { name: "Ubaid", role: "Social media marketing & SEO specialist", image: "/Ubaid.jpeg", position: "center 20%", initials: "UB" },
...
export default function About() {
  return (
    <>
      <Helmet>
        <title>
          About Growth Wave Digital | Our Story & Mission
        </title>

        <meta
          name="description"
          content="Learn about Growth Wave Digital and how we help businesses grow using AI-powered digital marketing strategies."
        />

        <link
          rel="canonical"
          href="https://www.growthwave.site/about"
        />
      </Helmet>
